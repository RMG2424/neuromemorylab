/**
 * jspsych-audio-keyboard-response-noerase
 * Josh de Leeuw
 *
...
jsPsych.plugins["audio-keyboard-response-noerase"] = (function () {

  var plugin = {};

  jsPsych.pluginAPI.registerPreload('audio-keyboard-response-noerase', 'stimulus', 'audio');
